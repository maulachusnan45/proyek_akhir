<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown">
        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Mata
            kuliah</span></a>
        <ul class="dropdown-menu">
      ...
      <li class="dropdown">
        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i>
          <span>Pengajuan Judul Skripsi</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link" href="../judul_skripsi/index.php">List Judul</a></li>
